...
The emergence of platforms like Open Collective has introduced unprecedented transparency to the financial management of open-source projects by making all transactions publicly visible. While corporate entities tend to provide larger individual donations, individual contributors are essential for long-term sustainability\cite{sample}, as they often provide higher total funding and demonstrate greater stickiness through recurring support. However, projects like OpenSSL illustrate that reliance on grassroots funding alone can be insufficient for critical infrastructure, often resulting in chronic underfunding until a major crisis occurs.

Surprisingly, over half of project expenditures are allocated to non-engineering activities, such as web services, marketing, and travel, rather than direct code development\cite{sample}.

Engineering-related funds are primarily spent on feature development, maintenance, and bounties to incentivize bug fixes. Although a positive correlation has been observed between corporate donation levels and project maintenance activity, the specific impact of diverse expenditure types on development productivity remains poorly understood. This study addresses this research gap by quantitatively analyzing the relationship between these financial flows and GitHub development metrics.

\subsection{Empirical Studies on Development Activity}
To evaluate the impact of external events on OSS projects, researchers typically utilize established repository metrics. Indicators such as the number of commits and pull requests (PRs) are widely accepted as proxies for development activity and productivity\cite{sample}. Additionally, community metrics such as stars and forks are used to measure project popularity and visibility\cite{sample}.
